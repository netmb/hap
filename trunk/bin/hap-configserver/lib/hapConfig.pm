...
__PACKAGE__->config( name => 'hapConfig', 'Plugin::ConfigLoader' => { file => $hap->{'BasePath'} . "/etc/hap.yml" }, hap => $hap );
__PACKAGE__->config->{static}->{include_path} = [ __PACKAGE__->config->{root}, __PACKAGE__->config->{root} . '/static', $hap->{'WebStaticPath'} ];
...
__PACKAGE__->deny_access_unless( "/managemodules/flashFirmware",  [qw/Flash_Firmware/] );
__PACKAGE__->deny_access_unless( "/managemodules/setModules",     [qw/Write/] );
__PACKAGE__->deny_access_unless( "/managemodules/pushConfig",     [qw/Push_Config/] );
__PACKAGE__->deny_access_unless( "/managemodules/resetModules",   [qw/Reset_Modules/] );
__PACKAGE__->deny_access_unless( "/managescheduler/setSchedules", [qw/Add_Schedules/] );
__PACKAGE__->deny_access_unless( "/managescheduler/delSchedules", [qw/Delete_Schedules/] );
...
__PACKAGE__->deny_access_unless( "/remotecontrollearned/learn",   [qw/Learn_IR/] );
